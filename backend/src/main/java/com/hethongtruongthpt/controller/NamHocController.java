...
public class NamHocController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<ApiResponse<NamHoc>> getById(@PathVariable Long id) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<ApiResponse<NamHoc>> update(@PathVariable Long id, @RequestBody NamHoc namHoc) {
