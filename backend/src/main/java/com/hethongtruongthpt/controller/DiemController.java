...
public class DiemController {
	...
	@GetMapping("/{id}")
	public ResponseEntity<ApiResponse<Diem>> getById(@PathVariable Long id) {
	...
	@PutMapping("/{id}")
	public ResponseEntity<ApiResponse<Diem>> update(@PathVariable Long id, @RequestBody Diem diem) {
