...
export const getDiemSummary = (params = {}) => axiosClient.get("/diem/summary", { params, timeout: 30000 });
export const getDiemAvgByGrade = (params = {}) => axiosClient.get("/diem/avg-by-grade", { params });
