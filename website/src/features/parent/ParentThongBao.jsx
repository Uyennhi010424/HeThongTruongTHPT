      ...
      <div style={{ background: "#fff", borderRadius: 12, width: "min(640px, 95vw)", maxHeight: "85vh", display: "flex", flexDirection: "column", boxShadow: "0 20px 60px rgba(0,0,0,0.3)" }}>
        ...
        <div style={{ padding: "12px 20px", borderTop: "1px solid #e5e7eb" }}>
          <textarea
            ...
            placeholder="Nhập phản hồi của bạn cho GVCN hoặc nhà trường..."
            rows={3}
...
export default function ParentThongBao() {
  ...
  const fetchNotices = async () => {
    try {
      ...
      const filtered = all.filter((n) => n.doiTuong === "PHU_HUYNH" || n.doiTuong === "ALL");
    ...
    <div className="page users-page student-page">
      <section className="student-hero card">
        <div className="student-hero-copy">
          ...
          <p className="student-hero-subtitle">Thông báo từ nhà trường dành cho phụ huynh.</p>
        </div>
